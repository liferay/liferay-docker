...
function generate_configuration {
	...
	write "services:"
	write "    database:"
	write "        command: mysqld --character-set-server=utf8mb4 --collation-server=utf8mb4_general_ci --character-set-filesystem=utf8mb4 --max_allowed_packet=256M --tls-version='' --version=5.7.38-google-log"
	write "        environment:"
