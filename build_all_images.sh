...
function build_bundle_images_dxp_74 {
	build_bundle_image \
		7.4.13-u8 \
		files.liferay.com/private/ee/portal/7.4.13.u8/liferay-dxp-tomcat-7.4.13.u8-20220215015721392.7z
...
function main {
	...
	local release_file_urls=(
		...
		releases.liferay.com/portal/7.4.3.12-ga12/liferay-ce-portal-tomcat-7.4.3.12-ga12-20220215025828785.7z
