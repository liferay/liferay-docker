...
function main {
	local release_file_urls=(
		...
		releases.liferay.com/portal/snapshot-7.1.x/201809071128/liferay-portal-tomcat-7.1.x.7z
		releases.liferay.com/portal/snapshot-7.1.x/201809110930/liferay-portal-tomcat-7.1.x.7z
