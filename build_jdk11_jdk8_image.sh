...
function build_docker_image {
	...
	then
		...
		docker buildx build \
			...
			--build-arg LABEL_ZULU_8_AMD64_VERSION="${LIFERAY_DOCKER_ZULU_8_AMD64_VERSION}" \
			--build-arg LABEL_ZULU_8_ARM64_VERSION="${LIFERAY_DOCKER_ZULU_8_ARM64_VERSION}" \
...
function main {
	...
	make_temp_directory templates/jdk11-jdk8 templates/_jdk
