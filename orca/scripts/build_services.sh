...
function build_service_liferay {
	...
	write 1 "        - LIFERAY_CONTAINER_STARTUP_LOCK_ENABLED=true"
	write 1 "        - LIFERAY_CONTAINER_STATUS_ENABLED=true"
	...
	write 1 "        - LIFERAY_THREAD_DUMP_PROBE_ENABLED=true"
	write 1 "        - LIFERAY_THREAD_DUMPS_DIRECTORY=/opt/liferay/data/sre/thread_dumps"
