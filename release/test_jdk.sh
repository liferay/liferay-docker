...
function test_jdk_set_jdk_version_and_parameters {
	...
	_test_jdk_set_jdk_version_and_parameters "2026.q1.3" "/opt/java/${_JDK_VERSION_17}" "${_JDK_PARAMETERS_17}"
	_test_jdk_set_jdk_version_and_parameters "2026.q1.4" "/opt/java/${_JDK_VERSION_17}" "${_JDK_PARAMETERS_17}"
	_test_jdk_set_jdk_version_and_parameters "2026.q2.0" "/opt/java/${_JDK_VERSION_17}" "${_JDK_PARAMETERS_17}"
