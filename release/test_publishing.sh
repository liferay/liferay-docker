...
function _test_get_patcher_product_version_label {
	...
	echo -e "Running _test_get_patcher_product_version_label for ${_PRODUCT_VERSION}.\n"
...
function _test_get_patcher_project_version {
	...
	echo -e "Running _test_get_patcher_project_version for ${_PRODUCT_VERSION}.\n"
...
function _test_get_root_patcher_project_version_name {
	...
	echo -e "Running _test_get_root_patcher_project_version_name for ${_PRODUCT_VERSION}.\n"
